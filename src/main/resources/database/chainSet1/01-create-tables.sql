...
-- changeset yourName:CreateAllTables

-- 1. Create the base "users" table (for User)
CREATE TABLE users (
...
-- 6. Create the table for Volunteer (subclass of User)
...
CREATE TABLE resource (
                          ...
                          CONSTRAINT fk_resource_org FOREIGN KEY (aid_organization_id) REFERENCES organization(id)
);
...
-- 13. Create the table for Donation
...
CREATE TABLE task (
                      ...
                      CONSTRAINT fk_task_resource FOREIGN KEY (resource_id) REFERENCES resource(id),
                      CONSTRAINT fk_task_volunteer FOREIGN KEY (volunteer_id) REFERENCES volunteer(id)
);
